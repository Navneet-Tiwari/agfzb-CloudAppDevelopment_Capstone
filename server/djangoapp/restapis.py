...
def get_dealer_reviews_from_cf(url, dealer_id):
    ...
    if json_result:
        ...
        # reviews = []
        # reviews_list = json.loads(json.loads(json_result)["data"])
        # for item in json_result:
        #     reviews.append(json_result[item])
        # reviews= list(json_result.split(" "))

        # print('review list : ', reviews)
...
def analyze_review_sentiments(review_text):
    ...
    api_key = 'bua6sBceLtGuRke6Okrw5mf-irm-adp3VWqKXmzWTyUF'
    url = 'https://api.jp-tok.natural-language-understanding.watson.cloud.ibm.com/instances/dc1e050a-7cf0-43bc-a607-08fbcde3b67a'
    version = '2022-04-07'
